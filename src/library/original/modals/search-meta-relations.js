(function (factory) {
    define("modals/search-meta-relations", ["knockout", "jquery", "parts/meta-relation-add", "parts/meta-relation-search"], factory);
    ...
    var Modal = (function () {
        ...
        Modal.prototype.loadLists = function () {
            var _ = this;
            $.get("/Admin/MetaRelation/SearchModalLists", null, function (response) {
