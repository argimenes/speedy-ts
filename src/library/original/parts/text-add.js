(function (factory) {
    ...
    const openModal = Helper.openModal;
    ...
    const changeCss = Helper.changeCss;
    ...
    var QuickAdd = (function () {
            ...
            var configuration = {
                ...
                event: {
                    ...
                    keyboard: {
                        ...
                        //"alt-LEFT-ARROW": function (args) {
                        //    const { editor } = args;
                        //    const panel = editor.client.window.text.node;
                        //    const rect = panel.getBoundingClientRect();
                        //    const x = rect.x - 10;
                        //    panel.style.left = x + "px";
                        //    //panel.style.transform = `translateX(-10px)`;
                        //},
                        //"alt-RIGHT-ARROW": function (args) {
                        //    const { editor } = args;
                        //    const panel = editor.client.window.text.node;
                        //    const rect = panel.getBoundingClientRect();
                        //    const x = rect.x + 10;
                    ...
                    afterMarkedInterval: (data) => {
                        const { editor } = data;
                        console.log("afterMarkedInterval", { data });
                        _this.saveClicked();
                    },
                    blockMouseOver: (data) => {
                ...
                onCharacterAdded: function (data) {
                    ...
                    //if (!_.state.typewriter.active()) {
                    //    return;
                    //}
                    //var url = '/content/audio/typewriter-key.wav';
                    //if (current.speedy.isSpace) {
                    //    url = '/content/audio/typewriter-space.wav';
                    //} else if (current.speedy.isLineBreak) {
                    //    url = '/content/audio/typewriter-line-break-1.wav';
                    //}
        ...
        QuickAdd.prototype.loadTimeline = function (options) {
        ...
        QuickAdd.prototype.toggleTypewriterClicked = function () {
        ...
        QuickAdd.prototype.showSidePanelClicked = function () {
        ...
        QuickAdd.prototype.textLoader = function () {
        ...
        QuickAdd.prototype.showKeyBindings = function () {
        ...
        QuickAdd.prototype.toggleAnnotationVisibilityClicked = function () {
            this.showAnnotationToggles(!this.showAnnotationToggles());
        };
        QuickAdd.prototype.toggle2 = function (name, value, attr, trueValue, falseValue) {
            var css = this.editor.propertyType[name].className;
            changeCss("." + css, attr, value ? trueValue : falseValue);
            return true;
        };        
        QuickAdd.prototype.listItemClicked = function () {
        ...
        QuickAdd.prototype.shiftAllLeftClicked = function () {
            this.editor.shiftPropertiesLeftFromCaret();
            return false;
        };
        QuickAdd.prototype.shiftAllRightClicked = function () {
        ...
        QuickAdd.prototype.showHide = function (name) {
        ...
        QuickAdd.prototype.syntaxClicked = function (lang) {
        ...
        QuickAdd.prototype.backCursor = function () {
            this.editor.backCursor();
        };
        QuickAdd.prototype.forwardCursor = function () {
        ...
        QuickAdd.prototype.pronounRecognitionClicked = function () {
        ...
        QuickAdd.prototype.lemmatizeClicked = function () {
        ...
        QuickAdd.prototype.layerClicked = function (layer) {
            var selected = layer.selected();
            this.editor.setLayerVisibility(layer.name, selected);
            return true;
        };
        QuickAdd.prototype.changeOpacityClicked = function () {
        ...
        QuickAdd.prototype.loadPdfWindow = function (data) {
            Functions.loadPdfWindow(data);
        };
        QuickAdd.prototype.loadWebsiteWindow = function (data) {
            Functions.loadWebsiteWindow(data);
        };
        QuickAdd.prototype.createYouTubeContent = function (args) {
            return Functions.createYouTubeContent(args);
        };
        QuickAdd.prototype.createVimeoContent = function (args) {
            return Functions.createVimeoContent(args);
        };
        QuickAdd.prototype.loadVideoWindow = function (data) {
            var _this = this;
        ...
        QuickAdd.prototype.createVideoContent = function (args) {
        ...
        QuickAdd.prototype.createVideoFileContent = function (args) {
            return Functions.createVideoFileContent(args);
        };
        QuickAdd.prototype.loadImageWindow = function (data) {
        ...
        QuickAdd.prototype.loadTweetWindow = function (data) {
            Functions.loadTweetWindow(data);
        };
        QuickAdd.prototype.loadSketchfabWindow = function (data) {
            Functions.loadSketchfabWindow(data);
        };
        QuickAdd.prototype.changeLineHeightClicked = function () {
            changeCss(".editor", "line-height", this.lineHeight());
        };
        QuickAdd.prototype.decreaseFontSize = function () {
        ...
        QuickAdd.prototype.increaseFontSize = function () {
            var fontSize = this.getFontSize();
            fontSize += 1;
            this.fontSize(fontSize + "px");
            this.changeFontSizeClicked();
        ...
        QuickAdd.prototype.getLineHeight = function () {
            var value = "16px";
        ...
        QuickAdd.prototype.getFontSize = function () {
            var fontSize = "16px";
            if (this.editor && this.editor.container) {
        ...
        QuickAdd.prototype.changeFontSizeClicked = function () {
            changeCss(".editor", "font-size", this.fontSize());
        };
        QuickAdd.prototype.changeFontFamilyClicked = function () {
            changeCss(".editor", "font-family", this.fontFamily());
        };
        QuickAdd.prototype.changeTextColourClicked = function () {
            changeCss(".editor", "color", this.textColour());
        };
        QuickAdd.prototype.changeBackgroundColourClicked = function () {
        ...
        QuickAdd.prototype.pageClicked = function () {
            this.editor.createProperty("page");
        };
        QuickAdd.prototype.domainClicked = function () {
            this.editor.createProperty("domain");
        };
        QuickAdd.prototype.languageClicked = function () {
        ...
        QuickAdd.prototype.tabClicked = function () {
