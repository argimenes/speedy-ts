(function (factory) {
    define("parts/trait-concept-search", ["knockout", "jquery", "app/helpers"], factory);
}(function (ko, $, Helper) {
    ...
    var Search = (function () {
        ...
        Search.prototype.searchAncestorClicked = function () {
            this.loadAncestors("Find Ancestor (Trait)", "search");
        };
        Search.prototype.loadAncestors = function (name, tabModal) {
            ...
            openModal("/Static/Templates/Concept/SearchModal.html", {
                ...
                ajaxContentAdded: function (element) {
                    var ConceptModal = require("modals/search-traits");
